...
const (
	...
	// NodeTypeObject is a legacy node type from a deprecated extraction strategy.
	// The modern refinery pipeline does not emit object nodes; it uses NodeTypeGeneric for unknown items.
	NodeTypeObject = "object"
	// NodeTypeResponse is a graph node representing a stored response or reply.
