...
// convertDatasize uses binary (1024) units: KiB, MiB, GiB, TiB (exposed as kb, mb, gb, tb).
...
// ConvertTemperature converts temperature between C, F, K (uses martinlindhe/unit).
func ConvertTemperature(value float64, from, to string) (float64, error) {
